...
function animate() {
    ...
    if (!firstFrameRendered) {
        ...
        // Set the flag to true to stop updating the elapsed time
        firstFrameRendered = true;
    }
}

// Create a DOM element to display the elapsed time
const elapsedTimeElement = document.createElement('div');
elapsedTimeElement.id = 'elapsedTime';
elapsedTimeElement.style.position = 'absolute';
elapsedTimeElement.style.top = '10px';
elapsedTimeElement.style.left = '10px';
elapsedTimeElement.style.color = 'white';
